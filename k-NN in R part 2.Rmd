---
title: " Exploratory Data Analysis in R using kNN part 2"
...
The second raw and second column section of the table tells us the number of cases which have been accurately predicted (TP-> True Positives) as Malignant (M).
